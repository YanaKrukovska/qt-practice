...
{
    if((event->buttons() & Qt::LeftButton) && isDrawingNow){
...
{
    if(event->button() == Qt::LeftButton && isDrawingNow){
        drawLineTo(event->pos());
        isDrawingNow = false;
    }
}
...
void Canvas::drawLineTo(const QPoint &endPoint)
{
    ...
    painter.setPen(QPen(currentBrushColor, currentPenWidth,
